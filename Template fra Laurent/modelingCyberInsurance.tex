...
In this simulation, the cost of insuring a link where chosen to violate the condition that ensured optimal results, and as we see in figure \ref{fig:SimulationViolating} the result was not optimal, there are only one clique and insured nodes are connected to non-insured. 
