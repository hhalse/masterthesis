...
\textbf{til hit!!}
so far our model reflects that a company have to insure each of the connections to other nodes in their network, inspired by other insurance products, we would like to introduce a discount rate following the degree of the nodes. This will make it more attractive for nodes with high degree to acquire insurance, and this could act as a incentive for other nodes to also acquire insurance. Thus this seems like a good model to include.  
