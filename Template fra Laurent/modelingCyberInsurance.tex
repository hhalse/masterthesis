...
Model 2 introduces parameters, which makes the modeling process much more realistic. 

første er en enkel modell som ikke gjør så mye. Vi ønsker å 

- skrive om modellene
en og en, hva er det vi egentlig adder


 For models 2,3 and 5, we created a simulator, to confirm the results of our calculations.
\begin{figure}[h]
\centering
