...
To be able to limit correlated risk and prevent the interdependent security problem, we want to find the conditions for when a trusted clique between insured nodes is formed. To do this we have to analyze the different scenarios. 
