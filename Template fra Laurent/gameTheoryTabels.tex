...
\begin{game}{4}{4}[Agent A][Agent B]
       						 \> $IL$  	\> $I\overline{L}$ 	\> $\overline{I}L$  \> $\overline{I}\overline{L}$   \\
$IL$     					 \> \underline{12} ,\underline{12}  	\> \underline{5},5   		\> 4,\underline{12}			\> \underline{5},2  \\
$I\overline{L}$   			 \> 5,\underline{5}  	\> \underline{5},\underline{5}    	\> \underline{5}, 2 				\> \underline{5},2\\
$\overline{I}L$      		 \> \underline{12},4  	\> 2,\underline{5}    			\> 4,4 					\> 2,2  \\
$\overline{I}\overline{L}$   \> 2,\underline{5} 	\> 2,\underline{5}   			\> 2,2 					\> 2,2 \\
\end{game}
\end{footnotesize}
\end{center}
\end{figure}
...
$I\overline{L}$   			 \> 5,\underline{5}  	\> \underline{5},\underline{5}    	\> 5, 2 				\> \underline{5},2\\
$\overline{I}L$      		 \> 12,\underline{6}  	\> 2,	  			\> 4,4 					\> 2,2  \\
$\overline{I}\overline{L}$   \> 2,\underline{5} 	\> 2,\underline{5}   			\> 2,2 					\> 2,2 \\
\end{game}
\end{footnotesize}
\end{center}
...
\begin{game}{4}{4}[Firm A][Firm B]
       						 \> $IL$  	\> $I\overline{L}$ 	\> $\overline{I}L$  \> $\overline{I}\overline{L}$   \\
$IL$     					 \> \underline{13} ,\underline{13}  	\> \underline{5},5   		\> 3,10			\> \underline{5},5  \\
$I\overline{L}$   			 \> 5,\underline{5}  	\> \underline{5},\underline{5}    	\> \underline{5}, 0 				\> \underline{5},0\\
$\overline{I}L$      		 \> 10,\underline{5}  	\> 0,\underline{5}    			\> 0,0 					\> 0,0  \\
$\overline{I}\overline{L}$   \> 0,\underline{5} 	\> 0,\underline{5}   			\> 0,0 					\> 0,0 \\
\end{game}
\end{footnotesize}
\end{center}
\end{figure}
...
\subparagraph{FIGUR SKAL OPPDATERE SEG}
\begin{figure}[h]
\begin{footnotesize}
\begin{center}
\begin{egame}(900, 500)
\egdirection{r}
\putbranch(100, 300)(1,1){200}\iib{1}{$I_{1}$}{$\overline{I_{1}}$}[][]
\putbranch(300, 500)(2,1){150}\iib{2}{$I_{2}$}{$\overline{I_{2}}$}[][]
\putbranch(450, 575)(3,1){150}\iib{1}{$L_{1}$}{$N_{1}$}[][$0,0$]
\putbranch(600, 625)(3,1){150}\iib{2}{$L^{I}_{2}$}{$N^{I}_{2}$}[$\beta-I_{l},\beta-I_{l}$][$0,0$]
\putbranch(450, 425)(3,1){150}\iib{1}{$N^{I}_{1}$}{$L^{I}_{1}$}[$0,0$][]
\putbranch(600,375)(3,1){150}\iib{2}{$L^{I}_{2}$}{$N^{I}_{2}$}[$\beta-I_{l}-r,\beta$][$0,0$]
\putbranch(300, 100)(2,1){150}\iib{2}{$I^{I}_{2}$}{$\overline{I^{I}_{2}}$}[][]
\putbranch(450, 175)(3,1){150}\iib{1}{$L^{II}_{1}$}{$N^{II}_{1}$}[][$0,0$]
\putbranch(600, 225)(3,1){150}\iib{2}{$L^{II}_{2}$}{$N^{II}_{2}$}[$\beta,\beta-I_{l}-r$][$0,0$]
\putbranch(450, 25)(3,1){150}\iib{1}{$N^{III}_{1}$}{$L^{III}_{1}$}[$0,0$][]
\putbranch(600, -25)(3,1){150}\iib{2}{$L^{III}_{2}$}{$N^{III}_{2}$}[$\beta-r,\beta-r$][$0,0$]
...
\begin{egame}(800,300)
\egdirection{r}
\putbranch(400,150)(0,1){100} \iib{\textbf{N}}{Insured (p)}{Not-insured (1-p)}
\putbranch(400,250)(1,0){350} \ib{\textbf{1}}[u]{L}
\putbranch(400,250)(1,0)[l]{350} \ib{\textbf{}}{N}[$U_{i},U_{i}$]
\putbranch(400,50)(1,0){350} \ib{\textbf{1}}[d]{L}
\putbranch(400,50)(1,0)[l]{350} \ib{\textbf{}}{N}[$U_{i},U_{i}$]
\putbranch(750,250)(2,1){150} \egalhshift=30 \iib{\textbf{2}}[u]{L}{N}[$U_{i}+\beta-I_{l},U_{i}+\beta-I_{l} $][$U_{i},U_{i}$]
\putbranch(750,50)(2,1){150} \egalhshift=30 \iib{\textbf{2}}[d]{L}{N}[$U_{i}+\beta,U_{i}+\beta-I_{l}-r $][$U_{i},U_{i}$]
\infoset(750,50){200}{}
...
\putbranch(400,50)(1,0){350} \ib{\textbf{1}}[d]{L}
\putbranch(400,50)(1,0)[l]{350} \ib{\textbf{}}{N}[$U_{i},U_{i}$]
\putbranch(750,250)(2,1){150} \egalhshift=30 \iib{\textbf{2}}[u]{L}{N}[$U_{i}+\beta-I_{l}-r,U_{i}+\beta$][$U_{i},U_{i}$]
\putbranch(750,50)(2,1){150} \egalhshift=30 \iib{\textbf{2}}[d]{L}{N}[$U_{i}+\beta-r,U_{i}+\beta-r $][$U_{i},U_{i}$]
\infoset(750,50){200}{}
