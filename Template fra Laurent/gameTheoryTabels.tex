...
$IL$     					 \> 13,13  	\> 5,5   			\> 5,10 				\> 5,0  \\
$I\overline{L}$   			 \> 5,5  	\> 5,5    			\> 5, 0 				\> 5,0\\
$\overline{I}L$      		 \> 10,5  	\> 0,5    			\> 10,10 				\> 0,0  \\
$\overline{I}\overline{L}$   \> 0,5 	\> 0,5   			\> 0, 0 				\> 0,0 \\
\end{game}
\end{footnotesize}
\end{center}
\end{figure}
...
\begin{game}{4}{4}[Firm A][Firm B]
       						 \> $IL$  	\> $I\overline{L}$ 	\> $\overline{I}L$  \> $\overline{I}\overline{L}$   \\
$IL$     					 \> $\alpha+\beta-I_{o}-I{l}-r$ ,13  	\> 5,5   			\> 5,10 				\> 5,0  \\
$I\overline{L}$   			 \> 5,\phantom{-}5  	\> $\begin{array}{l}\alpha+\beta-I_{o}-I{l}-r \\[0.0mm]\phantom{--}\alpha+\beta-I_{o}-I{l}-r \end{array}$  			\> 5, 0 				\> 5,0\\
$\overline{I}L$      		 \> $\begin{array}{rl}\alpha+\beta-I_{o}-I{l}-r&\\[0.6mm]&\alpha+\beta-I_{o}-I{l}-r\end{array}$  	\> 0,5    			\> 10,10 				\> 0,0  \\
$\overline{I}\overline{L}$   \> 0,5 	\> 0,5   			\> 0, 0 				\> 0,0 \\
\end{game}
\end{footnotesize}
\end{center}
