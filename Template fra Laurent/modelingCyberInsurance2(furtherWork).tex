...
Lets look at an example, where the parameters are set to: $\beta=0.9, I_{l}=0.5$, and the resulting network are shown in Figure \ref{fig:stablestar}.
