...
In our paper an insurable topology, is an network structure which makes it feasible for both the
 ...
 For this to be possible there are many  difficulties to overcome,  one example are the correlated risks, for the insurer the problem is to be able to calculate the overall probability of casualty/infection.
