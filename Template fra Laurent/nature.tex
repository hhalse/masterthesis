...
So far our thesis have introduced cyber-insurance, presented related work on the issues regarding cyber-insurance and this the last chapter have presented different graph structures and briefly introduced the idea of network formation. Generally the models in the related work section have taken different approaches to problems regarding cyber-insurance and analyzed the outcome to see how well they contribute. Our approach does the opposite, in this chapter we have reviled different structures (star and clique) which will benefit both the insurer and nodes in a cyber-insurance market. We will combine the knowledge of these structures and network formation to investigate whether it is possible for the insurer to control the formation of the cyber-insurance network. Our approach will focus on endogenous formation by controlling the cost parameters for the insurer. Basically, we know that if the insurance premium is high, no one will buy it. On the other hand, if it is free, everyone would benefit from having one, and clique formations will emerge. We want to determine whether it is possible to find the intersections, which will create the desired structures where both the insurer and their customers will benefit from cyber-insurances. 




\subparagraph{NOTES. research question}
